...
\begin{itemize}[nosep]
    ...
    \item \texttt{model\_class} (enum) --- Model architecture variant: \texttt{frankenstein} (mixed-architecture encoder) or \texttt{frankesteindecoder} (autoregressive causal decoder). Required when \texttt{base\_model} is not set.
...
\begin{enumerate}[nosep]
    ...
    \item \texttt{model\_class: frankesteindecoder} forces \texttt{model.dims.mode: decoder} at runtime. Setting \texttt{model.dims.mode: encoder} with this class is overridden.
