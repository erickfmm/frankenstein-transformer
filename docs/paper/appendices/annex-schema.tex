...
The \texttt{model.dims.layer\_pattern} array accepts the following 35 mixer types. Each element defines one physical layer in the model stack. Table~\ref{tab:layer-pattern-enum} lists all available types with their training and inference support.
