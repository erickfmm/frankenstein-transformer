...
dims.layer\_pattern & array of enum (obligatorio) & Secuencia ordenada de tipos de capa. La longitud debe igualar \texttt{num\_layers}. Más de 35 tipos de mezclador disponibles (ver Tabla~\ref{tab:layer-pattern}). \\
\midrule
...
El array \texttt{model.dims.layer\_pattern} acepta los siguientes 35 tipos de mezclador. Cada elemento define una capa física en la pila del modelo. La Tabla~\ref{tab:layer-pattern-enum} enumera todos los tipos disponibles con su soporte de entrenamiento e inferencia.
