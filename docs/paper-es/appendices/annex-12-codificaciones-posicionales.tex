...
Los 11 valores del enum se agrupan en cuatro estilos de inyección:
...
ha eliminado --- los 11 valores ahora funcionan con cada mezclador.

\subsection{Perfil Arquitectónico: Codificaciones Posicionales}

La Tabla~\ref{tab:all-pos-enc} resume las 11 codificaciones posicionales
soportadas.
