...
- **Training presets**: `configs/*.yaml` (named: `frankenstein`, `frankesteindecoder`, `standard`, `tinybert`, `embbert`, …) and `configs/examples/*.yaml` (optimizer × architecture combos).
