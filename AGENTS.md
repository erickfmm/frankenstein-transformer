...
| Modify **Vision Transformer (frankenstein_vit)** | `src/model/frankenstein_vit.py`, `src/model/config.py` (vision fields), `src/schema/_image.yaml`, `src/schema/_dataset.yaml`, `src/schema/_vision_*.yaml`, `src/utils/config_flatten.py` (`flatten_image_dict`), `src/training/vision_dataset.py`, `src/training/trainer.py` (vision loss methods), `src/training/main.py` (`_run_vision_task`), `src/deploy/{deploy,inference,transformers_export}.py` (ViT branches), `configs/frankenstein_vit_base.yaml`, `configs/examples/vit_*.yaml`, `tests/test_frankenstein_vit.py`, `tests/test_vision_dataset.py`, `tests/test_vision_loss.py`, `docs/specs/vision.md` |
